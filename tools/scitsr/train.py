...
class Trainer:
    ...
    def _to_device1(self, data):
        data.nodes = data.nodes.cpu()
        data.edges = data.edges.cpu()
        data.adj = data.adj.cpu()
        data.incidence = data.incidence.cpu()
        if data.labels is not None:
            data.labels = data.labels.cpu()
        torch.cuda.empty_cache()
...
if __name__ == '__main__':
    ...
    train_path = "/home/cjc/SciTSR-master/SciTSR/train"
    test_path = "/home/cjc/SciTSR-master/SciTSR/test"

...
class IC15Evaluator(object):
    def __init__(self, opt, LTRB = True):
        ...
        self.gt_dict, self.scale_dict, self.gt_box_sum = self.create_gt_dict(self.data_list)
    ...
    def create_gt_dict(self, data_list):
        ...
        for ind in range(gt_size):
            ...
            table_img  = Image.open(table_anno['image_path'].replace('/data/xuewenyuan/data','datasets')).convert("RGB")
        ...
        return gt_dict, scale_dict, gt_box_sum
